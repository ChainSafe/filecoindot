...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    filecoindot: {
       ...
       **/
      closeBlockProposal: AugmentedSubmittable<(blockCid: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes]>;
      /**
       ...
       **/
      submitBlockVote: AugmentedSubmittable<(blockCid: Bytes | string | Uint8Array, messageRootCid: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, Bytes]>;
      /**
       * Verify the state of the filecoin
       **/
      verifyMessage: AugmentedSubmittable<(proof: Vec<Bytes> | (Bytes | string | Uint8Array)[], blockCid: Bytes | string | Uint8Array, cid: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<Bytes>, Bytes, Bytes]>;
      /**
       * Verify the receipt of the filecoin
       **/
      verifyReceipt: AugmentedSubmittable<(proof: Vec<Bytes> | (Bytes | string | Uint8Array)[], blockCid: Bytes | string | Uint8Array, cid: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<Bytes>, Bytes, Bytes]>;
      /**
       * Verify the state of the filecoin
       **/
      verifyState: AugmentedSubmittable<(proof: Vec<Bytes> | (Bytes | string | Uint8Array)[], blockCid: Bytes | string | Uint8Array, cid: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<Bytes>, Bytes, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    filecoindotNFT: {
       ...
       **/
      mint: AugmentedSubmittable<(cid: Bytes | string | Uint8Array, proof: Vec<Bytes> | (Bytes | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Bytes, Vec<Bytes>]>;
      /**
       * Transfer the nft specified with `token_id` from the sender to `to` account
       **/
      transfer: AugmentedSubmittable<(to: AccountId32 | string | Uint8Array, tokenId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
